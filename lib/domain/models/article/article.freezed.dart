...
class _$ArticleSourceImpl extends _ArticleSource {
  const _$ArticleSourceImpl({this.id, this.name}) : super._();
...
abstract class _ArticleSource extends ArticleSource {
  const factory _ArticleSource({final String? id, final String? name}) =
      _$ArticleSourceImpl;
  const _ArticleSource._() : super._();
